...
public record AdminUpdateBySuperAdminDto
{
...
public class AdminUpdateBySuperAdminDtoValidator : AbstractValidator<AdminUpdateBySuperAdminDto>
{
    public AdminUpdateBySuperAdminDtoValidator()
    {
        RuleFor(a => a.Name)
            .NotEmpty()
