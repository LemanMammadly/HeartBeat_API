...
public record CreateAdminstratorDto
{
...
public class CreateAdminstratorDtoValidator:AbstractValidator<CreateAdminstratorDto>
{
    public CreateAdminstratorDtoValidator()
    {
        RuleFor(a => a.Name)
            .NotEmpty()
        ...
        RuleFor(d => d.Salary)
            .GreaterThan(500)
                .WithMessage("Adminstrator salary must be greater than 500");
        RuleFor(d => d.Age)
            .GreaterThan(18)
